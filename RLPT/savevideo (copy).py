...
for i in range(12):
	...
	os.mkdir(folder)
	os.system("python trainMS.py gym_chrono.envs:gvsets-v0 GVSETS.pth -l=1e-4 -e=1 -s=300 -u=1000 -m=150 -p=6 -a=MultiSensorEarlyFusion --play_mode --max_episodes="+str(i))
