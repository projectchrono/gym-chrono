...
class off_road_v2(ChronoBaseEnv):
    ...
    def get_ob(self):
        ...
        array_data = np.concatenate([gps_data, [head], [speed]])
    ...
    def calc_rew(self):
        ...
        rew = dist_coeff/(dist+0.05)# + vel_coeff*vel + time_cost*self.system.GetChTime()
        return rew
