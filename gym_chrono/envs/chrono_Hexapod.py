...
class Model(object):
       def __init__(self, render):
              self.animate = render
              self.observation_space = np.empty([53,])
              self.action_space = np.zeros([18,])
              self.Xtarg = 0.0
              self.Ztarg = 1000.0
              ...
              self.m_datapath = "C:/codes/Chrono/Chrono_Source/data/"
       ...
       def reset(self):
              ...
              #ll = self.hexapod_sys.Get_linklist()
              #print('link rimasti:')
              ...
              for i in range(len(self.con_link)):
                     ...
                     #TODO: set FALSE to motor constraint
