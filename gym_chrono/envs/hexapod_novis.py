...
shapes_dir = 'hexapod_novis_shapes/' 
...
body_1.SetInertiaXY(chrono.ChVectorD(-2.69334937812053e-06,-3.45986868931097e-05,-1.36555187966808e-06))
...
body_2.SetInertiaXY(chrono.ChVectorD(-1.41697255304101e-07,2.95285471512551e-07,-1.53816834697879e-05))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.000357126198687972,0.0192584708003122,-0.00163277336304941),chrono.ChQuaternionD(1,0,0,0)))
...
body_3.SetInertiaXX(chrono.ChVectorD(8.0035953017937e-06,9.62220940012943e-06,8.94046148663445e-06))
body_3.SetInertiaXY(chrono.ChVectorD(3.43276308382499e-07,-1.15018100669991e-06,3.18739690085474e-07))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.000962714713021326,0.000962714691254138,0.0260087993424653),chrono.ChQuaternionD(1,0,0,0)))
...
body_4.SetInertiaXX(chrono.ChVectorD(1.23274187765565e-05,3.00016445513906e-05,2.9557502965817e-05))
body_4.SetInertiaXY(chrono.ChVectorD(-1.14197057182094e-06,-2.22499641184027e-06,2.1026864540246e-06))
body_4.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000733373824915609,-0.0207493752198647,0.00315852037890482),chrono.ChQuaternionD(1,0,0,0)))
...
body_5.SetInertiaXX(chrono.ChVectorD(3.01244345268188e-05,0.000105187880008893,0.000108478866134613))
body_5.SetInertiaXY(chrono.ChVectorD(-1.65269886560117e-05,3.08955817458714e-07,1.20961418011772e-07))
body_5.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0159616525902916,-0.0203081631545103,0.000240966541478179),chrono.ChQuaternionD(1,0,0,0)))
...
body_6.SetInertiaXX(chrono.ChVectorD(1.23274187765565e-05,3.18822602126284e-05,2.76768873045792e-05))
body_6.SetInertiaXY(chrono.ChVectorD(-2.38080518617805e-06,-7.65814915677936e-07,-2.22070792786802e-07))
...
body_7.SetInertiaXY(chrono.ChVectorD(3.18739690085381e-07,1.15018100669965e-06,-3.43276308382588e-07))
body_7.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.000962714713021326,0.000962714691254138,0.0260087993424653),chrono.ChQuaternionD(1,0,0,0)))
...
body_8.SetInertiaXX(chrono.ChVectorD(7.32184738751417e-06,9.62220940012943e-06,9.62220940091398e-06))
body_8.SetInertiaXY(chrono.ChVectorD(-4.68116001770688e-07,4.68433092420373e-07,1.73500091852126e-08))
...
body_10.SetInertiaXY(chrono.ChVectorD(2.38080518617806e-06,7.65814915677936e-07,-2.22070792786804e-07))
body_10.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000733373824915608,-0.0207493752198646,0.00315852037890483),chrono.ChQuaternionD(1,0,0,0)))
...
body_11.SetInertiaXY(chrono.ChVectorD(-2.32880204231332e-06,3.48406057056257e-05,1.21764804326916e-06))
body_11.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0159616525902916,-0.0203081631545103,0.000240966541478179),chrono.ChQuaternionD(1,0,0,0)))
...
body_12.SetInertiaXY(chrono.ChVectorD(2.07959928259302e-05,-3.31690481850393e-08,3.30129029368096e-07))
body_12.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0159616525902916,-0.0203081631545103,0.000240966541478179),chrono.ChQuaternionD(1,0,0,0)))
...
body_14.SetInertiaXX(chrono.ChVectorD(7.32184738751416e-06,9.62220940012942e-06,9.62220940091398e-06))
body_14.SetInertiaXY(chrono.ChVectorD(4.68116001770687e-07,4.68433092420372e-07,-1.73500091852123e-08))
body_14.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.000962714713021326,0.000962714691254138,0.0260087993424653),chrono.ChQuaternionD(1,0,0,0)))
...
body_15.SetInertiaXX(chrono.ChVectorD(8.0035953017937e-06,9.62220940012943e-06,8.94046148663445e-06))
body_15.SetInertiaXY(chrono.ChVectorD(-3.432763083825e-07,-1.15018100669991e-06,-3.18739690085475e-07))
...
body_16.SetInertiaXY(chrono.ChVectorD(2.22499641184028e-06,-1.14197057182093e-06,-2.1026864540246e-06))
body_16.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000733373824915609,-0.0207493752198647,0.00315852037890482),chrono.ChQuaternionD(1,0,0,0)))
...
body_17.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000733373824915608,-0.0207493752198646,0.00315852037890483),chrono.ChQuaternionD(1,0,0,0)))
...
body_18.SetInertiaXX(chrono.ChVectorD(1.23274187765565e-05,3.00016445513906e-05,2.95575029658171e-05))
body_18.SetInertiaXY(chrono.ChVectorD(1.14197057182095e-06,2.22499641184029e-06,2.1026864540246e-06))
body_18.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000733373824915609,-0.0207493752198647,0.00315852037890482),chrono.ChQuaternionD(1,0,0,0)))
...
body_19.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.000962714713021327,0.000962714691254141,0.0260087993424653),chrono.ChQuaternionD(1,0,0,0)))
...
body_20.SetInertiaXY(chrono.ChVectorD(-7.76333868838184e-08,-3.23343716350289e-07,1.76078253615458e-07))
body_20.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0846037978523311,-0.0708768966115268,-1.72553688872241e-05),chrono.ChQuaternionD(1,0,0,0)))
...
body_21.SetInertiaXY(chrono.ChVectorD(-4.1286803799555e-07,-3.04112106436446e-07,2.07534423694475e-07))
body_21.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0846037978523311,-0.0708768966115268,-1.72553688872246e-05),chrono.ChQuaternionD(1,0,0,0)))
...
body_22.SetInertiaXY(chrono.ChVectorD(-4.74093390179693e-07,8.00187251922356e-22,-1.2018145693162e-21))
...
body_23.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0846037978523311,-0.0708768966115268,-1.72553688872238e-05),chrono.ChQuaternionD(1,0,0,0)))
...
body_24.SetInertiaXY(chrono.ChVectorD(-4.12868037995549e-07,3.04112106436446e-07,-2.07534423694476e-07))
body_24.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0846037978523311,-0.0708768966115268,-1.72553688872247e-05),chrono.ChQuaternionD(1,0,0,0)))
...
body_25.SetInertiaXY(chrono.ChVectorD(-4.74093390179693e-07,4.58278538382781e-22,-6.49120092632993e-22))
body_25.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0846037978523311,-0.0708768966115268,-1.72553688872243e-05),chrono.ChQuaternionD(1,0,0,0)))
